(function () {
    $Dojo = function (idPassedIn) {
        console.log("$Dojo loaded!");
        if (idPassedIn === undefined) console.log("$Dojo needs more parameters passed in. ");
        
        $Dojo.click = function(){
            console.log('Dojo.click needs more parameters passed in.');
        }
        
        $Dojo.click = function(callback){
            console.log('$Dojo click function called!');
        }
        /*
