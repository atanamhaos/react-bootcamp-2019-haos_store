...
var server = http.createServer(function (request, response) {
    ...
    else if (request.url === '/css/form.css') {
        fs.readFile('css/form.css', 'utf8', function (errors, contents) {
    ...
    // request didn't match anything: the URL requested is not available.
    else {
