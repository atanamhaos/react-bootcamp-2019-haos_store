...
* Modified as interpretor see it
...
console.log(makeDojo("Berkeley", 0)); // logs 'closed for now' (actually Throws an error)
...
A.  Rewrite the given code as it is seen by the interpreter
B.  Predict the outputs
C.  Run the original code and compare the outputs to your predictions
